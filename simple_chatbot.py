# Simple Developer ChatBot using agno
from agno.agent import Agent
from agno.models.ollama import Ollama

# Create the agent with Leonard's information
agent = Agent(
...
def main():
    print("🤖 Leonard Waugh Developer Information ChatBot")
    print("=" * 50)
    print("Ask me anything about Leonard's background, skills, experience, or projects!")
